...
│   └── new-blueprint.sh            ← scaffolds a new blueprint folder skeleton
├── .github/
│   └── workflows/
│       ├── lint-charts.yaml        ← lint + template dry-run on every pull request
...
├── CHANGELOG.md                    ← history of blueprint additions and updates
